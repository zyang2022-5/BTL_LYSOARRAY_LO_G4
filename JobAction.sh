...
OutPut="JobTest"   # Name of the Root output files from the G4 executable 

### Main action
ActionSH=$BASEDIR/G4SimScriptCVMFS.sh
sh $ActionSH -a $SimArgs -n $SimName -m $MacroName -b $BASEDIR -f $buildfol -v 0 -o $OutPut
