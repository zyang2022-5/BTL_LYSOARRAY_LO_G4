...
OutPut="GC1_FLResin_Muon_S_Incr_"   # Name of the Root output files from the G4 executable 
...
echo $Sopt
cd $BASEDIR
./$SimName -o $OutPut -GeomConfig 1 -m run200.mac -Muon -incrS $Sopt -nDetected
