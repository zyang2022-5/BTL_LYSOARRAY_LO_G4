...
{// constructor
    ...
    //LYSO_thick=10./2.;
    // Declare folder for new messengers
    fMessenger_thick2 = new G4GenericMessenger(this, "/detector/","Detector Construction");
    // name for new messengers
    fMessenger_thick2->DeclareProperty("LYSO_thick2", LYSO_thick2, "Section dimension for the LYSO in mm");
...
////////////////////
    ...
    else if (GeomConfig==2)
    {
       G4Trap* trapLYSO1 = new G4Trap("trapLYSO",       //G4String& pName,
                            ...
                            LYSO_thick2*mm, LYSO_thick2*mm,   //G4double pDx1, G4double pDx2,
                            0.,LYSO_thick*mm,               //G4double pAlp1, G4double pDy2,
                            LYSO_thick2*mm,LYSO_thick2*mm,    //G4double pDx3, G4double pDx4,
                            0.);            //G4double pAlp2)
